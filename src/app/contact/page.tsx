  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-gray-800 mb-8">Hubungi Kami</h1>
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Jl. Pendidikan No. 123<br />Jakarta, Indonesia 12345</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">perpustakaan@sekolah.sch.id</p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-4">
                  ...
                  <p className="text-gray-600">Senin - Jumat: 08:00 - 17:00<br />Sabtu: 08:00 - 12:00</p>
                </div>
              </div>
            </div>
          </div>
            ...
            {submitted ? (
              <div className="bg-green-50 border border-green-200 text-green-700 px-4 py-3 rounded-lg mb-6">
                <div className="flex">
                  ...
                  <p>Pesan Anda telah terkirim! Kami akan segera merespon.</p>
                </div>
              </div>
            ) : null}
